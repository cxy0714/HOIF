...
R_results <- compute_HOIF_general_all_U(Vector_1 = residuals$R1, Vector_2 = residuals$r1, weight = A, basis = Z,Split= 1 )
HOIF_1_split_R_test <-  c(R_results$eHOIF_HOIF2, R_results$eHOIF_HOIF3,R_results$eHOIF_HOIF4,R_results$eHOIF_HOIF5,R_results$eHOIF_HOIF6)

all.equal(results_split$HOIF1, HOIF_1_split_R_test )
results_split$HOIF1
HOIF_test_split$HOIF_1_m
HOIF_1_split_R_test


R_results <- compute_HOIF_general_all_U(Vector_1 = residuals$R0, Vector_2 = residuals$r0, weight = 1- A, basis = Z,Split= 1, seed = seed )
HOIF_0_split_R_test <-  c(R_results$eHOIF_HOIF2, R_results$eHOIF_HOIF3,R_results$eHOIF_HOIF4,R_results$eHOIF_HOIF5,R_results$eHOIF_HOIF6)

all.equal(results_split$HOIF0, HOIF_0_split_R_test )
results_split$HOIF0
HOIF_test_split$HOIF_0_m
HOIF_0_split_R_test
...
#
# R_results <- compute_HOIF_general_all_U(Vector_1 = residuals$R1, Vector_2 = residuals$r1, weight = A, basis = Z )
# HOIF_1_R_test <-  c(R_results$sHOIF_HOIF2, R_results$sHOIF_HOIF3,R_results$sHOIF_HOIF4,R_results$sHOIF_HOIF5,R_results$sHOIF_HOIF6)
# all.equal(results$HOIF1, HOIF_1_R_test )
# HOIF_1_R_test
# results$HOIF1
# HOIF_test$HOIF_1_m
