...
Let's demonstrate the recommended workflow with a simple simulated example,
...
functions. Here we use simple (generalized) linear models; in practice, any
flexible machine learning method can be used.
